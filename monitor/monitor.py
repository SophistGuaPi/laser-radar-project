...
class monitor:
    def __init__(self):
        ...
        self.CEMG = c_char(1)
        self.x_axis = [0, 0, 1000, 1000, 100, 100, 1, 1]
        self.y_axis = [0, 0, 1000, 1000, 1000, 9000, 10, 10]
    ...
    def del_move(self):
        ...
        erro = self.DAQdll.DeltMov_2XE(0, 1, 0, self.y_axis[0], self.y_axis[1], self.y_axis[2], self.y_axis[3], self.y_axis[4], self.y_axis[5],
